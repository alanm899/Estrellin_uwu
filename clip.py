...
async def addstreamer(
    ...
    try:
        ...
        if DEBUG_MODE:
            print(f"[DEBUG] database.json creado/actualizado. Streamer {streamer_name} agregado al canal {target_channel.id}.")
    except Exception as e:
        print(f"[ERROR] No se pudo crear/actualizar database.json: {e}")
